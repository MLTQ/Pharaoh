...
## Rationale
- AudioLDM v1 exposes duration control and upstream examples include long samples/soundscapes. The production integration should use the upstream `audioldm` runner rather than the deprecated diffusers pipeline inside the Woosh environment.
