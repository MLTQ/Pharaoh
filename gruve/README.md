...
Guard against echo loops (don't rebroadcast while applying a remote value), debounce bursty state
(drags), and validate values off the wire through your store's own setters.
